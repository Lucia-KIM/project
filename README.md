...
```
### 프로젝트 리스트(구분)
|그로스 마케팅 분석|데이터 분석|예측 모델링|
|------|---|---|
|패션기업 고객 분석|국민연금 데이터를 활용한 유니콘 기업 발굴|공유 주차장 앱 이용자 수요예측|
|공유 주차장 앱 사용자 분석|주식 데이터 분석|인구조사 소득 예측|
| |세종시 인구 및 도시 데이터 분석|서울시 아파트 실거래가 지수 예측|


# [그로스  프로젝트(Growth Marketing Analyst)]
...
## 1. 국민연금DB 이용 유니콘 기업 발굴하기 (기업 실데이터 사용)  
